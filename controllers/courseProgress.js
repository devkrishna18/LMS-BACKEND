/*User finishes video →
Frontend calls API with courseId + subSectionId →
Backend:
  ↳ Validate SubSection exists
  ↳ Find CourseProgress for (user, course)
  ↳ If not found → error
  ↳ If video already marked → skip
  ↳ Else → push subSectionId → save → success response*/
